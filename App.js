      ...
      <View style={[ Styles.Column, { flex: 1}]}>
        ...
        <View style={Styles.Container}>
          <View style={Styles.DescriptionContainer}>
            ...
            <CustomViews.ItemView customStyles={{justifyContent: 'center'}}>
              <Text style={[Styles.bold , Styles.fontSize(20)]}>3h</Text>
              <Text style = {Styles.regular}>Next Break Due</Text>
            </CustomViews.ItemView>
          </View>
          <View style={Styles.MainContentContainer}>
            <CustomViews.LargeTile color={'#BCFDEC'} src={require('./images/click.png')} description={"START DRIVING"} click={this.changeModalVisibilty} />
            <View style={Styles.ContentContainer}>
              <CustomViews.SmallTile src={require('./images/economy.png')} color='#F0EFC7' title='Start Other Work' style={Styles.margin("marginRight" , 7)} />
              <CustomViews.SmallTile src={require('./images/break-time.png')} color='#D9DFF9' title='Start Rest' style={Styles.margin("marginLeft" , 7)} />
            </View>
            <CustomViews.LargeTile color="#EEDCF7" src={require('./images/time.png')} description={"END OF DAY"} />
          </View>
          <CustomViews.Remarks />
